...
function enviarLaudoPorEmail(email, nome, perfil) {
  return new Promise(function(resolve) {
    ...
    fetch('https://formspree.io/f/xdavnaje', {
      ...
      // BANNER DE DEBUG - fica fixo na tela, não redireciona sozinho
      var banner = document.createElement('div');
      banner.style.cssText = 'position:fixed;top:0;left:0;right:0;background:#ff0000;color:#fff;padding:16px;font-size:14px;z-index:999999;font-family:monospace;word-break:break-all;';
      banner.innerHTML = '<b>DEBUG v9</b><br>URL: ' + window.location.href
